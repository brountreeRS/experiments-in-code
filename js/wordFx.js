 ...
 */
{
    ...
    class Shape {
        ...
        configureShapeType() {
            ...
            if (this.type === 'circle') {
                ...
                const w = randomBetween(0.15, 1.5, 3) * this.letterRect.width;
                //const h = randomBetween(0.15, 1.5, 3) * this.letterRect.height;
                const h = w;
    ...
    class Word {
        ...
        createSVG() {
            ...
            this.DOM.svg.setAttribute('width', `${winsize.width}px` + "200px");
            this.DOM.svg.setAttribute('height', `${winsize.width}px`);
            this.DOM.svg.setAttribute('viewbox', `0 0 ${(winsize.width) + "200px"} ${winsize.height}`);

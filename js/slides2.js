...
$(window).on("load", function () {
	...
	$(document).on("keydown", function (a) {
		var b = 2.5,
			...
			f = d.scrollTop(),
			g = f + parseInt(b * c);
		window.disableKeyNavigation || "input" == a.target.nodeName.toLowerCase() || "textarea" == a.target.nodeName.toLowerCase() || (37 === a.keyCode && (a.preventDefault(), window.horizontalMode && window.changeSlide("decrease")), 38 === a.keyCode && (window.horizontalMode ? (a.preventDefault(), TweenLite.to(d, window.scrollSpeed, {
			scrollTo: {
				y: g,
				autoKill: !0
			},

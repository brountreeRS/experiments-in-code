        ...
        openItem(menuItem) {
            ...
            this.openItemTimeline = new TimelineMax({
                ...
                .staggerTo(menuItem.DOM.letters, duration * .7, {
                    ease: ease,
                    cycle: {
                        y: (i, _) => i % 2 == 0 ? MathUtils.getRandomFloat(-50, -50) : MathUtils.getRandomFloat(50, 50)
                    },
                ...
                .staggerTo(contentItem.DOM.titleLetters, duration, {
                    ...
                    startAt: {
                        cycle: {
                            y: (i, _) => i % 2 == 0 ? MathUtils.getRandomFloat(-120, -15) : MathUtils.getRandomFloat(115, 135),
                            rotation: MathUtils.getRandomFloat(-70, 0)
                        }
                    },
                    y: 0,
                    rotation: 0,
